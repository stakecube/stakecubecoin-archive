Stakecube version 2.3.1 is now available from:
...
Stakecube is extensively tested on multiple operating systems using
...
Stakecube should also work on most other Unix-like systems but is not
