...
This mechanism has been integrated into Bitcore-Node-Stakecube which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Stakecube-Project/insight-api-stakecube#web-socket-api](https://github.com/Stakecube-Project/insight-api-stakecube#web-socket-api) 
* API: [https://github.com/Stakecube-Project/insight-api-stakecube#swifttx-transactions](https://github.com/Stakecube-Project/insight-api-stakecube#swifttx-transactions) 
...
By default, the Stakecube daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stakecube daemon:
