...
This mechanism has been integrated into Bitcore-Node-LightPayCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LightPayCoin-Project/insight-api-lightpaycoin#web-socket-api](https://github.com/LightPayCoin-Project/insight-api-lightpaycoin#web-socket-api) 
* API: [https://github.com/LightPayCoin-Project/insight-api-lightpaycoin#swifttx-transactions](https://github.com/LightPayCoin-Project/insight-api-lightpaycoin#swifttx-transactions) 
...
By default, the LightPayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LightPayCoin Core daemon:
