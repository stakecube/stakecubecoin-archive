TOR SUPPORT IN MonetaryUnit
=======================

It is possible to run MonetaryUnit as a Tor hidden service, and connect to such services.
...
Run MonetaryUnit behind a Tor proxy
----------------------------------

The first step is running MonetaryUnit behind a Tor proxy. This will already make all
...
```
./monetaryunitd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./monetaryunitd -proxy=127.0.0.1:9050
```

Run a MonetaryUnit hidden server
-------------------------------
...
-externalip=X   You can tell monetaryunit about its publicly reachable address using
                ...
                /var/lib/tor/monetaryunit-service/hostname. Onion addresses are given
...
```
./monetaryunitd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./monetaryunitd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known MonetaryUnit Tor relays
------------------------------------
```
