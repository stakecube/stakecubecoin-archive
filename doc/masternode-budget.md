...
MonetaryUnit now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<monetaryunit_address\> \<monthly_payment_monetaryunit\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MonetaryUnit, _12_ times over the course of a year totaling _24000_ MonetaryUnit.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<monetaryunit_address\> \<monthly_payment_monetaryunit\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MonetaryUnit.
