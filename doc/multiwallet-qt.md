...
In order to support loading of multiple wallets in stakecube-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stakecube.cpp.
...
Changes to stakecube.cpp
----------------------
stakecube.cpp is the entry point into stakecube-qt, and as such, will require some minor modifications to provide hooks for
