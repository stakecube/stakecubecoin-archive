...
In order to support loading of multiple wallets in stakecubecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stakecubecoin.cpp.
...
Changes to stakecubecoin.cpp
----------------------
stakecubecoin.cpp is the entry point into stakecubecoin-qt, and as such, will require some minor modifications to provide hooks for
