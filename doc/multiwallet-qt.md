...
In order to support loading of multiple wallets in lightpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lightpaycoin.cpp.
...
Changes to lightpaycoin.cpp
----------------------
lightpaycoin.cpp is the entry point into lightpaycoin-qt, and as such, will require some minor modifications to provide hooks for
