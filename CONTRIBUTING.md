Contributing to StakeCubeCoin
============================

The StakeCubeCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the StakeCubeCoin project, and is not to be
confused with overall StakeCubeCoin Network Protocol consensus changes.

Whether a pull request is merged into StakeCubeCoin rests with the project merge
...
Patches that change StakeCubeCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the StakeCubeCoin consensus, it must have been
...
The project leader is the release manager for each StakeCubeCoin release.
