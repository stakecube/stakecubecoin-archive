Contributing to MonetaryUnit Core
============================

The MonetaryUnit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MonetaryUnit Core project, and is not to be
confused with overall MonetaryUnit Network Protocol consensus changes.

Whether a pull request is merged into MonetaryUnit Core rests with the project merge
...
Patches that change MonetaryUnit consensus rules are considerably more involved than
...
Where a patch set proposes to change the MonetaryUnit consensus, it must have been
...
The project leader is the release manager for each MonetaryUnit Core release.
