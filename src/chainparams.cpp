...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 200;
        nSccBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nSccBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 500;
        nZerocoinStartHeight = 863787;
        nZerocoinStartTime = 3000000000; // October 17, 2017 4:30:00 AM
        nBlockEnforceSerialRange = 4194194; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = 4194194; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = 4194194; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 4194194; //Last valid accumulator checkpoint
        nBlockEnforceInvalidUTXO = 4194194; //Start enforcing the invalid UTXO's
        nInvalidAmountFiltered = 268200*COIN; //Amount of invalid coins filtered through exchanges, that should be considered valid
        nBlockZerocoinV2 = 4194194; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        nBlockDoubleAccumulated = 4194194;
        ...
        nBlockStakeModifierlV2 = 4194194;
        // Public coin spend enforcement
        nPublicZCSpends = 1880000;

        // Fake Serial Attack
        nFakeSerialBlockheightEnd = 4194194;
...
public:
    CTestNetParams()
    {
        ...
        nLastPOWBlock = 200;
        nSccBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nSccBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
