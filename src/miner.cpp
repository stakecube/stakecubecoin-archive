...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("StakeCubeCoreMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("StakeCubeCoreMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("StakeCubeCoreMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running StakeCubeCoreMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
