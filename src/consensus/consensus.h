...
#ifndef STAKECUBE_CONSENSUS_CONSENSUS_H
#define STAKECUBE_CONSENSUS_CONSENSUS_H
...
static const unsigned int MAX_BLOCK_SIZE_LEGACY = MAX_BLOCK_SIZE_CURRENT;
...
#endif // STAKECUBE_CONSENSUS_CONSENSUS_H
