...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StakeCubeCoin stakecubecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stakecubecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stakecubecoin transaction") + "\n" +
                               "  stakecubecoin-tx [options] -create [commands]   " + _("Create hex-encoded stakecubecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stakecubecoin transaction
