...
// StakeCubeCoin: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == NetMsgType::SPORK) {
        ...
        // StakeCubeCoin: add to spork database.
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_4_RESERVED) r = SPORK_4_RESERVED_DEFAULT;
        if (nSporkID == SPORK_5_MAX_VALUE) r = SPORK_5_MAX_VALUE_DEFAULT;
        if (nSporkID == SPORK_6_RESERVED) r = SPORK_6_RESERVED_DEFAULT;
        ...
        if (nSporkID == SPORK_11_ENABLE_SUPERBLOCKS) r = SPORK_11_ENABLE_SUPERBLOCKS_DEFAULT;
        ...
        if (nSporkID == SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT) r = SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT_DEFAULT;
...
bool IsSporkActive(int nSporkID)
{
    if (Params().NetworkID() == CBaseChainParams::REGTEST) {
        if(nSporkID == SPORK_11_ENABLE_SUPERBLOCKS) {
            return true;
        }
    }
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_4_RESERVED") return SPORK_4_RESERVED;
    if (strName == "SPORK_5_MAX_VALUE") return SPORK_5_MAX_VALUE;
    if (strName == "SPORK_6_RESERVED") return SPORK_6_RESERVED;
    ...
    if (strName == "SPORK_11_ENABLE_SUPERBLOCKS") return SPORK_11_ENABLE_SUPERBLOCKS;
    ...
    if (strName == "SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT") return SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_4_RESERVED) return "SPORK_4_RESERVED";
    if (id == SPORK_5_MAX_VALUE) return "SPORK_5_MAX_VALUE";
    if (id == SPORK_6_RESERVED) return "SPORK_6_RESERVED";
    ...
    if (id == SPORK_11_ENABLE_SUPERBLOCKS) return "SPORK_11_ENABLE_SUPERBLOCKS";
    ...
    if (id == SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT) return "SPORK_16_NEW_PROTOCOL_70815_ENFORCEMENT";
