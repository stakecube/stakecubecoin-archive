...
#ifndef SCC_ZPIVTRACKER_H
#define SCC_ZPIVTRACKER_H
...
public:
    CzSCCTracker(std::string strWalletFile);
    ~CzSCCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSCCWallet* zSCCWallet = NULL);
