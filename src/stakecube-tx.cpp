...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Stakecube Core stakecube-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stakecube-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stakecube transaction") + "\n" +
                               "  stakecube-tx [options] -create [commands]   " + _("Create hex-encoded stakecube transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stakecube transaction
