...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lightpaycoin Core lightpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lightpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lightpaycoin transaction") + "\n" +
                               "  lightpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded lightpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lightpaycoin transaction
