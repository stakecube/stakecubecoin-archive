...
/** Utility functions used by the LightPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LightPayCoin addresses in monospace font
...
// Parse "lightpaycoin:" URI into recipient object, return true on successful parsing
