...
/** Utility functions used by the StakeCubeCore Qt UI.
 */
namespace GUIUtil
{
...
// Render StakeCubeCore addresses in monospace font
...
// Parse "stakecube:" URI into recipient object, return true on successful parsing
