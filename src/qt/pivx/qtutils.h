...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, SCCGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, SCCGUI *gui, double posX = 3);
