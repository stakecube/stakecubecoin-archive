    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of share a SCC address, you can create a Payment Request message which bundles up more information than is contained in just a SCC address."));
