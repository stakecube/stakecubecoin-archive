                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Stakecube² Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stakecube² address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Stakecube² Core"), this);
    aboutAction->setStatusTip(tr("Show information about Stakecube² Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Stakecube²"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stakecube² addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stakecube² addresses"));
    ...
    openAction->setStatusTip(tr("Open a Stakecube²: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stakecube² Core help message to get a list with possible Stakecube² command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Stakecube² Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stakecube² network", "", count));
}
...
{
    QString strTitle = tr("Stakecube² Core"); // default title
