                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StakeCubeCore") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a StakeCubeCore address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StakeCubeCore"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your StakeCubeCore addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified StakeCubeCore addresses"));
    ...
    openAction->setStatusTip(tr("Open a StakeCubeCore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StakeCubeCore help message to get a list with possible StakeCubeCore command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StakeCubeCore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StakeCubeCore network", "", count));
}
...
{
    QString strTitle = tr("StakeCubeCore"); // default title
