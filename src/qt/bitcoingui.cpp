                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StakeCubeCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a StakeCubeCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stakecubecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About StakeCubeCoin"), this);
    aboutAction->setStatusTip(tr("Show information about StakeCubeCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StakeCubeCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your StakeCubeCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified StakeCubeCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a StakeCubeCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StakeCubeCoin help message to get a list with possible StakeCubeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StakeCubeCoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StakeCubeCoin network", "", count));
}
...
{
    QString strTitle = tr("StakeCubeCoin"); // default title
