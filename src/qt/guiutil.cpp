...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Stakecube² address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no Stakecube²: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Stakecube².lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Stakecube².lnk
