...
StartOptionsMain::StartOptionsMain(QWidget *parent)
    ...
    this->setWindowTitle("StakeCubeCoin Wallet Setup");
    ...
    switch (pageNum){
        ...
        case 4:{
            ...
            if(CMnemonic::Check(seedphrase)){
                ...
                QString error = "Unfortunately, your words seem to be invalid. This is most likely because one or more are misspelled. Please double check your spelling and word order. If you continue to have this issue, your words may not currently be in our dictionary.";
                StartOptionsDialog dlg(error, this);
                dlg.exec();
            }
