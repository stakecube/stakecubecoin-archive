...
{
    QString CSS = "body {font-size:12px; background-color: #9fbef4; color:#000;}\n a, span { font-family: monospace; }\n span.addr {color:#001c4c; font-weight: bold;}\n table tr td {padding: 3px; border: none; background-color: #9fbef4;}\n td.d0 {font-weight: bold; color:#f8f8f8;}\n h2, h3 { white-space:nowrap; color:#1B7884;}\n a { text-decoration:none; }\n a.nav {color:green;}\n";
